...
In this paper, we demonstrate the main functionality of the **`bp`** package by exploring and analyzing both a single-subject pilot study of $\color{red}{\text{[Schwenck]}}$ and a multi-subject study, HYPNOS $\color{red}{\text{[source]}}$, to illustrate the differences between dataset structures and elaborate how to adjust the settings within the R package to accommodate either. 
...
bp_mag      | Blood Pressure Magnitude                | [Munter et al (2011)](https://doi.org/10.1097/HJH.0b013e32834cf213 )
...
dip_calc    | Nocturnal Dipping \% and Classification | [Okhubo et al (1997)](https://doi.org/10.1016/s0895-7061(97)00274-4)
...
bp_scatter       | Blood Pressure Stage Scatter Plot ([American Heart Association](https://www.heart.org/en/health-topics/high-blood-pressure/understanding-blood-pressure-readings))
...
bptable_ex <- dow_tod_plots(data2)
...
* Added visuals that incorporate heart rate, time, sleep status (`WAKE`), and existing metrics (dip_calc, etc)
